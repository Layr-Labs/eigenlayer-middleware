...
contract ServiceManagerMigration_UnitTests is MockAVSDeployer, IServiceManagerBaseEvents {
    ...
    function setUp() public virtual {
        ...
        // Deploy StakeRootCompendium
        stakeRootCompendium = new StakeRootCompendium(
            IDelegationManager(delegationMock),
        ...
        serviceManagerImplementation = new ServiceManagerMock(
            avsDirectory, rewardsCoordinator, stakeRootCompendium, registryCoordinator, stakeRegistry
        );
    ...
    function test_migrateToOperatorSets() public {
        ...
        serviceManager.migrateAndCreateOperatorSetIds(operatorSetsToCreate, new uint256[](operatorSetsToCreate.length));
    ...
    function test_migrateToOperatorSets_verify() public {
        vm.skip(true);
        /// TODO: This is failing because createQuorum isn't propogating the info to the stakeRegistry since
        /// the registry coordinator has changed
