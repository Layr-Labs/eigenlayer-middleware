...
contract BN254TableCalculatorHarness is BN254TableCalculator {
    constructor(
        IKeyRegistrar _keyRegistrar,
        IAllocationManager _allocationManager,
        uint256 _LOOKAHEAD_BLOCKS
    ) BN254TableCalculator(_keyRegistrar, _allocationManager, _LOOKAHEAD_BLOCKS) {}
...
/**
 * @title BN254TableCalculatorUnitTests
...
contract BN254TableCalculatorUnitTests is MockEigenLayerDeployer, IOperatorTableCalculatorTypes {
    ...
    // Test contracts
    BN254TableCalculatorHarness public calculator;
    ...
    function setUp() public virtual {
        ...
        calculator = new BN254TableCalculatorHarness(
...
/**
 * @title BN254TableCalculatorUnitTests_getOperatorWeights
 * @notice Unit tests for BN254TableCalculator._getOperatorWeights
 */
