...
contract BLSSignatureCheckerUnitTests is BLSMockAVSDeployer {
    ...
    function testFuzz_checkSignatures_SingleQuorum(uint256 pseudoRandomNumber) public {
        ...
        (BLSSignatureChecker.QuorumStakeTotals memory quorumStakeTotals, bytes32 signatoryRecordHash) =
    ...
    function test_checkSignatures_SingleQuorum() public {
        ...
        assertEq(quorumStakeTotals.signedStakeForQuorum[0], 3_000_000_000_000_000_000, "signedStakeForQuorum incorrect");
        assertEq(quorumStakeTotals.totalStakeForQuorum[0], 4_000_000_000_000_000_000, "totalStakeForQuorum incorrect");
    }
    ...
    function test_checkSignatures_revert_inputLengthMismatch() public {
        ...
        IBLSSignatureChecker.NonSignerStakesAndSignature memory incorrectLengthInputs = IBLSSignatureChecker
        ...
        blsSignatureChecker.checkSignatures(msgHash, quorumNumbers, referenceBlockNumber, incorrectLengthInputs);
    ...
    function test_checkSignatures_revert_referenceBlockNumberInFuture(uint256 pseudoRandomNumber) public {
        ...
        blsSignatureChecker.checkSignatures(msgHash, quorumNumbers, invalidReferenceBlock, nonSignerStakesAndSignature);
    }
