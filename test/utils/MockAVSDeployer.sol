...
import {StakeRegistry} from "../../src/outdated/StakeRegistry.sol";
import {IndexRegistry} from "../../src/outdated/IndexRegistry.sol";
...
contract MockAVSDeployer is Test {
    ...
    StakeRootCompendium public stakeRootCompendium;
    ...
    function _deployMockEigenLayerAndAVS(
        ...
        registryCoordinatorImplementation = new RegistryCoordinatorHarness(
            serviceManager, stakeRootCompendium, blsApkRegistry, avsDirectory
        );
        {
    ...
    function _setOperatorWeight(
        ...
        delegationMock.setOperatorShares(operator, IStrategy(address(420)), weight);
        return weight;
    }
