...
contract RegistryCoordinatorHarness is RegistryCoordinator, Test {
    ...
    ) RegistryCoordinator(_serviceManager, _stakeRootCompendium, _blsApkRegistry, _avsDirectory) {
    ...
    function _registerOperatorExternal(
        ...
        // TODO:
        // _registerOperator(operator, operatorId, quorumNumbers, socket, operatorSignature);
    }
