...
/**
 * @notice Builds on top of the LinearWeightQuorum, adding an OperatorQualityOracle, that it references
 ...
 * on top of the calculation performed by the `LinearWeightQuorum.weightOfOperator` function,
 ...
 */
abstract contract LinearWeightQuorumWithOracle is LinearWeightQuorum {
    ...
    *******************************************************************************/
    ...
    function weightOfOperator(address operator) public virtual override view returns (uint256) {
        uint256 weight = LinearWeightQuorum.weightOfOperator(operator);
