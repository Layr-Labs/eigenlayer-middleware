...
contract ECDSAServiceManagerBase is IServiceManager, OwnableUpgradeable {
    ...
    ECDSARegistryCoordinator internal immutable _registryCoordinator;
    IDelegationManager internal immutable _delegationManager;
    ECDSAStakeRegistry internal immutable _stakeRegistry;
    ...
    constructor(
        ...
        ECDSARegistryCoordinator __registryCoordinator,
        ECDSAStakeRegistry __stakeRegistry
    ) {
    ...
    function getOperatorRestakedStrategies(address operator) external view returns (address[] memory) {
        address operatorId = _registryCoordinator.getOperatorId(operator);
        uint256 operatorBitmap = _registryCoordinator.getCurrentQuorumBitmap(operatorId);
