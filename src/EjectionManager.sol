...
contract EjectionManager is IEjectionManager, OwnableUpgradeable {
    ...
    function ejectOperators(
        ...
        require(
            ...
            "EjectionManager.ejectOperators: Only owner or ejector can eject"
        );
    ...
    function _setQuorumEjectionParams(
        ...
        require(
            _quorumNumber < MAX_QUORUM_COUNT,
            "EjectionManager._setQuorumEjectionParams: Quorum number exceeds MAX_QUORUM_COUNT"
        );
