 ...
 */
contract BLSSignatureChecker is Initializable, IBLSSignatureChecker {
    ...
    function __BLSSignatureChecker_init(bool _staleStakesForbidden)
        internal
        virtual
        onlyInitializing
    {
        staleStakesForbidden = _staleStakesForbidden;
    }
