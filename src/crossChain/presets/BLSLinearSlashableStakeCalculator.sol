...
import {LinearSlashableStakeCalculator} from
    "../stakeCalculators/LinearSlashableStakeCalculator.sol";
...
contract BLSLinearSlashableStakeCalculator is BLSTableCalculator, LinearSlashableStakeCalculator {
    ...
    function getOperatorWeights(
        ...
        view
        virtual
        override(BLSTableCalculator, LinearSlashableStakeCalculator)
